...
class DiffusionProcess:
    ...
    def forward_diffusion(self, x_0, t, e):
        ...
        sqrt_one_minus_alpha = self.combine_timestep(torch.sqrt(1. - self.alphas_bar), t, x_0.device)
    ...
    def reverse_diffusion(self, x, t, e, z):
        ...
        sqrt_recip_alphas = self.combine_timestep(torch.sqrt(1.0 / self.alphas), t, x.device)
        scale = self.combine_timestep((1 - self.alphas) / torch.sqrt(1. - self.alphas_bar), t, x.device)
